<header class="main-header" style="background-color:#427D9D " >
  <!-- Logo -->
  <a href="#" class="logo " style="background-color: #427D9D">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini" style="background-color: #427D9D "><b>O</b>VS</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg " style="background-color:#427D9D ;color:white ; font-size: 22px; font-family:Times  "><marquee behavior="scroll" direction="left">Online Voting System</marquee></span>
    

  </a>
  <!-- Header Navbar: style can be found in header.less -->
  <nav class="navbar navbar-static-top " style="background-color: #427D9D ">
    ...
    <div class="navbar-custom-menu" style="color:black ; font-size: 17px; font-family:Times">
      <ul class="nav navbar-nav" style="background-color: #427D9D ;color:black ; font-size: 17px; font-family:Times" >
        <!-- User Account: style can be found in dropdown.less -->
        <li class="dropdown user user-menu  " style="color:black">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #427D9D ;color:white ; font-size: 17px; font-family:Times" >
          ...
          <ul class="dropdown-menu" style="background-color: #4d5863 ;color:black ; font-size: 17px; font-family:Times">
            ...
            <li class="user-header" style="background-color:#4d5863 ;color:black ; font-size: 17px; font-family:Times">
              ...
              <p>
                ...
                <small>Member since <?php $currentDateTime = new DateTime('now'); echo $currentDateTime->format('F Y'); ?></small>
              </p>
            </li>
