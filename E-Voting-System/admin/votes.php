...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:#40A2E3;color:black ; font-size: 17px; font-family:Times ">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box"style="background-color: #DDE6ED">
            <div class="box-header with-border"style="background-color: #DDE6ED">
