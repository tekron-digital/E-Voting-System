<aside class="main-sidebar "style="background-color: #164863 ">
  <!-- sidebar: style can be found in sidebar.less -->
  <section class="sidebar" style="background-color: #164863">
    <!-- Sidebar user panel -->
    ...
    <ul class="sidebar-menu" data-widget="tree" style="background-color: #19A7CE ; color:white ; font-size: 15px; font-family:Times  " >
